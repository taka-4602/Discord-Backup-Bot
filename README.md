...
このBotを作った時はそうでもなかったんですが、最近僕の環境で429が頻発してます  
対策としてはtime.sleepを1回のリクエストごとに挟んだり、最後のメッセージ送信にも挟んだりすることが挙げられます  
このあたりはDiscord側の裁量なので明確にこうしたら起きるとかこれで絶対安全といえる措置がないです  
Bot部分になるnin.py系のファイル全部に429を検出させるコードも追加しておいたので各自で気をつけてください！！
### 追記：👆Replitでホスティングしていることが原因 ~~の可能性が高いみたいです~~ でした
