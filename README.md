...
## 新機能 (v8)
### Webインターフェース
- ✨ **ランディングページ**: Bot機能の紹介とナビゲーション
- 📖 **セットアップガイド**: 詳細なインストール手順
- ❓ **FAQ**: よくある質問と回答
- 💰 **料金プラン**: 利用プランの説明
- 🎯 **ExoClick広告統合**: 認証ページと主要ページに広告を配置

### Webページへのアクセス
Botを起動すると、以下のURLでWebページにアクセスできます：
- ランディングページ: `http://your-domain:5000/`
- セットアップガイド: `http://your-domain:5000/setup`
- FAQ: `http://your-domain:5000/faq`
- 料金プラン: `http://your-domain:5000/pricing`
...
## 仕様定義書
詳細なシステム仕様、API仕様、データ構造については、[SPECIFICATION.md](SPECIFICATION.md)を参照してください。
